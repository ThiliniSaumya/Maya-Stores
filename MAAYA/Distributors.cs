...
namespace MAAYA
{
    public partial class Distributors : Form
    {
        ...
        private void suppier_Load(object sender, EventArgs e)
        {
            ...
            button2.BackColor = Color.FromArgb(21, 149, 197);
            ...
            dataGridView2.BackgroundColor = Color.FromArgb(0, 90, 158);
            dataGridView2.BorderStyle = BorderStyle.None;
            dataGridView2.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(79, 119, 135);//maruwata pennana color
            dataGridView2.CellBorderStyle = DataGridViewCellBorderStyle.None;
            dataGridView2.DefaultCellStyle.SelectionBackColor = Color.Gray;//selec krn row eka
            dataGridView2.DefaultCellStyle.SelectionForeColor = Color.Black;

            dataGridView2.EnableHeadersVisualStyles = false;
            dataGridView2.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            dataGridView2.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(11, 40, 88);//totole color
            dataGridView2.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;////titile eke font eka
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                String MyConnection = "datasource=localhost;Database=maaya;username=root;password=;";
