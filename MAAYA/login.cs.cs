...
namespace MAAYA
{
    public partial class login : Form
    {
        ...
        {
            InitializeComponent();
            button3.BackColor = Color.FromArgb(0, 108, 189);
        }
        ...
        private void login_Load(object sender, EventArgs e)
        {
            ...
            button1.BackColor = Color.FromArgb(50, 123, 176);
        ...
        {
            button2.BackColor = Color.FromArgb(0, 108, 189);
            button3.BackColor = Color.FromArgb(0, 90, 158);
            button4.BackColor = Color.FromArgb(0, 90, 158);
            label6.Text = "Manager";
            selectUser = "Manager";
        ...
        {
            button3.BackColor = Color.FromArgb(0, 108, 189);
            button2.BackColor = Color.FromArgb(0, 90, 158);
            button4.BackColor = Color.FromArgb(0, 90, 158);
            label6.Text = "Cashier";
            selectUser = "Cashier";
        ...
        {
            button4.BackColor = Color.FromArgb(0, 108, 189);
            button2.BackColor = Color.FromArgb(0, 90, 158);
            button3.BackColor = Color.FromArgb(0, 90, 158);
